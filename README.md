...
**If you use PyFLOWGO please cite the following reference ** (books, articles, reports, etc.):

"Chevrel M.O., Labroquère J., Harris A. and Rowland S. (2017). PyFLOWGO: an open-source platform for simulation of channelized lava thermo-rheological properties. Accepted for publication in Computers and Geosciences, Nov. 2017"
