...
class MyTestCase(unittest.TestCase):
    def test_read_initial_condition_from_json_file(self):
        ...
        yield_strength_model_ryerson = pyflowgo.flowgo_yield_strength_model_ryerson.FlowGoYieldStrengthModelRyerson()
        yield_strength_model_ryerson.read_initial_condition_from_json_file(filename)

        self.assertEqual(yield_strength_model_ryerson._eruption_temperature, 1387.15)
    ...
    def test_compute_yield_strength(self):
        ...
        yield_strength = yield_strength_model_ryerson.compute_yield_strength(state,eruption_temperature=1387.15)

        self.assertAlmostEqual(yield_strength, 10.2673501622,10)
    ...
    def test_compute_basal_shear_stress(self):
        ...
        state = pyflowgo.flowgo_state.FlowGoState()
        basal_shear_stress = yield_strength_model_ryerson.compute_basal_shear_stress(state, terrain_condition,
                                                                                   material_lava)
