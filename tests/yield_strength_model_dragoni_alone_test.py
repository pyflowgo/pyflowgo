...
class MyTestCase(unittest.TestCase):
    def test_read_initial_condition_from_json_file(self):
        ...
        yield_strength_model_dragoni_alone = pyflowgo.flowgo_yield_strength_model_dragoni_alone.FlowGoYieldStrengthModelDragoniAlone()
        yield_strength_model_dragoni_alone.read_initial_condition_from_json_file(filename)

        self.assertEqual(yield_strength_model_dragoni_alone._liquidus_temperature, 1400)
    ...
    def test_compute_yield_strength(self):
        ...
        yield_strength = yield_strength_model_dragoni_alone.compute_yield_strength(state,eruption_temperature=1387.15)

        self.assertAlmostEqual(yield_strength, 0.0102839568,10)
    ...
    def test_compute_basal_shear_stress(self):
        ...
        state = pyflowgo.flowgo_state.FlowGoState()
        basal_shear_stress = yield_strength_model_dragoni_alone.compute_basal_shear_stress(state, terrain_condition,
                                                                                   material_lava)
