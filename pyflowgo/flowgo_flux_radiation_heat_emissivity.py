...
class FlowGoFluxRadiationHeat(pyflowgo.base.flowgo_base_flux.FlowGoBaseFlux):
    ...
    def __init__(self, terrain_condition, material_lava, material_air, crust_temperature_model,
                 effective_cover_crust_model):
    ...
    def _compute_epsilon_effective(self, state, terrain_condition):
        ...
        epsilon_effective = effective_cover_fraction * emissivity_crust + (
                    1. - effective_cover_fraction) * emissivity_molten
